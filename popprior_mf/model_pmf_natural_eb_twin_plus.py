...
from model_variational_family_natural_eb_plus import VariationalFamilyNaturalEBPlus


class PMFNaturalEBTwinPlus(PMFNaturalEBPlus):
    ...
    def _setup_column_vars(
        ...
        self.qv_distribution = VariationalFamilyNaturalEBPlus(
            device=self.device,
            family=family,
