...
class PMFNaturalEB(PMFNatural):
    ...
    def _setup_row_vars(
        ...
        #print("Testing! Using Normalizing Flow!!!")
        self.qu_distribution = VariationalFamilyNaturalEBNormalizingFlow(
        #self.qu_distribution = VariationalFamilyNaturalEB(
            device=self.device,
            family=family,
